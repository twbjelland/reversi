...
io.sockets.on('connection', function (socket) {
	...
	function log(){
		...
		*    {
					...
					'membership' : # of ppl in room including new One_Room
				}
				or
				{
				'result', 'fail',
...
*    {
		...
		*    {
					'result', 'success',
					'username' : socket id of the person being invited
				}	or
					{
					'result', 'fail',
					'message': failure message
...
*/
		...
		socket.on('invite',function(payload){
			...
			/* Check that message can be traced to username */
				...
				/*Tell the inviteee that they have been invited */
				var success_data = {
															result: "success",
															socket_id: socket.id
														};
	...
	socket.on('uninvite',function(payload){
		...
		/* Check that message can be traced to username */
			...
			/*Tell the uninviteee that they have been invited */
			var success_data = {
														result: "success",
														socket_id: socket.id
													};
...
//////////////////////////////////////////////////////////////////////////////
	...
	{ 'row': 0-7 the row to play the token on
		'column': -07 the column to play the token on
...
function send_game_update(socket, game_id, message){
	...
	/* ensure that only 2 ppl are in the game room */
	var roomObject;
	var numClients;
	do{
